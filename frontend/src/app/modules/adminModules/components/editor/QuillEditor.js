...
import { apiUrl, imgUrl } from "core/contexts/constants";
...
class QuillEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    // console.log("description_quill:", this.props.description);
  ...
  insertImage = (e) => {
    ...
    if (
      ...
      axios.post(`${apiUrl}/uploadimage`, formData, config).then((response) => {
        if (response.data.successImage) {
          ...
          quill.insertEmbed(position, "image", {
            src: imgUrl + response.data.messageImage,
    ...
    return (
      <div>
        <div id="toolbar">
          ...
          <button className="ql-insertImage">Image</button>
          <button className="ql-insertVideo">Video</button>
